...
KukaWrapper::KukaWrapper(std::string urdf_path){
...
Eigen::Matrix<double, 7, 1> KukaWrapper::inverse_kinematic(Eigen::Matrix3d orientation, Eigen::Vector3d position){
...
Eigen::Matrix<double, NDOF, 1> KukaWrapper::inverse_velocities(Eigen::Matrix<double, NDOF, 1> q, Eigen::Vector3d linear_velocity, Eigen::Vector3d angular_velocity){
...
Eigen::Matrix<double, 6, 1> KukaWrapper::forward_velocities(Eigen::Matrix<double, NDOF, 1> q, Eigen::Matrix<double, NDOF, 1> qdot){
