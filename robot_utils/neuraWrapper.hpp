...
public:
  ...
  */
  ...
  Eigen::Matrix<double, NDOF, 1> max_acceleration{3.0, 3.0, 3.0, 3.0, 3.0, 3.0, 3.0}; //{3.0, 3.0, 3.0, 3.0, 3.0, 3.0, 3.0}; // TODO
  Eigen::Matrix<double, NDOF, 1> max_jerk{10.0, 10.0, 10.0, 10.0, 10.0, 10.0, 10.0};  //{10.0, 10.0, 10.0, 10.0, 10.0, 10.0, 10.0};        // TODO
  Eigen::Matrix<double, NDOF, 1> max_torque{320, 320, 176, 176, 110, 40, 40};         // TODO
  double max_torqueDot{100.0};                                                        // TODO
