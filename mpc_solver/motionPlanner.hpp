...
class MotionPlanner {
    ...
    public:
        ...
        std::tuple<Eigen::Matrix<double, 3, 1>, Eigen::Matrix<double, 3, 3>> forward_kinematics(Eigen::Matrix<double, NDOF, 1> q);

        std::tuple<Eigen::Matrix<double, 3, 1>, Eigen::Matrix<double, 3, 3>> forward_kinematics(Eigen::Matrix<double, NDOF, 1> q, std::string frame_name);
...
PYBIND11_MODULE(motion_planning_lib, m) {
    py::class_<MotionPlanner<PandaWrapper>>(m, "PandaMotionPlanner")
        ...
        .def("forward_kinematics", static_cast<std::tuple<Eigen::Matrix<double, 3, 1>, Eigen::Matrix<double, 3, 3>>(MotionPlanner<PandaWrapper>::*)(Eigen::Matrix<double, NDOF, 1>)>(&MotionPlanner<PandaWrapper>::forward_kinematics))
    ...
    py::class_<MotionPlanner<Kuka7Wrapper>>(m, "Kuka7MotionPlanner")
        ...
        .def("forward_kinematics", static_cast<std::tuple<Eigen::Matrix<double, 3, 1>, Eigen::Matrix<double, 3, 3>> (MotionPlanner<Kuka7Wrapper>::*)(Eigen::Matrix<double, NDOF, 1>)>(&MotionPlanner<Kuka7Wrapper>::forward_kinematics))
    ...
    py::class_<MotionPlanner<Kuka14Wrapper>>(m, "Kuka14MotionPlanner")
        ...
        .def("forward_kinematics", static_cast<std::tuple<Eigen::Matrix<double, 3, 1>, Eigen::Matrix<double, 3, 3>> (MotionPlanner<Kuka14Wrapper>::*)(Eigen::Matrix<double, NDOF, 1>)>(&MotionPlanner<Kuka14Wrapper>::forward_kinematics))
