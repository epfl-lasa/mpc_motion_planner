...
j_max = (7500, 3750, 5000, 6250, 7500, 10000, 10000)
...
ul = np.array([2.8973, 1.7628, 2.8973, -0.0698, 2.8973, 3.7525, 2.8973])      # Upper limit
ll = np.array([-2.8973, -1.7628, -2.8973, -3.0718, -2.8973, -0.0175, -2.8973])  # Lower limit
